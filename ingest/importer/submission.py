...
class EntityLinker(object):
    ...
    def process_links_from_spreadsheet(self, entity_map: EntityMap):
    ...
    def _generate_direct_links(self, entity_map: EntityMap, entity: Entity):
    ...
    def link_process(self, entity_map: EntityMap, linked_process_id: str, linking_details: dict):
    ...
    def _validate_entity_links(self, entity_map: EntityMap, entity: Entity):
        links_by_entity = entity.links_by_entity
    ...
    def create_or_get_process(self, entity_map: EntityMap, process_id: str, linking_details: dict):
